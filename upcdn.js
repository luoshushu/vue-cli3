...
var config = {
  qiniu: {
    accessKey: 'NZfqJDXE2FI-xekDt-wPzVCOdUKdoNroGWe_nP7T',  // 个人中心 秘钥管理里的 AccessKey
    secretKey: 'heBorOlTDtnxlXbQpyqZN71_C2KDEenctAQOu8B-',  // 个人中心 秘钥管理里的 SecretKey
    bucket: options.scope,
    domain: 'http://pm3ag2m29.bkt.clouddn.com'
  }
}
